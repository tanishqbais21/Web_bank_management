...
function required()
{
var empt = document.forms["form1"]["funds"].value;
if (empt == "")
{
alert("Please input Amount to add");
return false;
}
...
<div class="grad">
 ...
 <div class=login>
 <form name="form1" action="add_money1">
 <h3>Enter Amount To Be Added Into Your Account<br><br><input type="text" name="funds" class="box"><br>
